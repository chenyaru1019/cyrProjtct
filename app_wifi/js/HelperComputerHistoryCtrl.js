angular.module('starter.HelperComputerHistoryCtrl', [])

    .controller('HelperComputerHistoryCtrl', function($scope,$state,service,$rootScope,$timeout,
        ...
        $scope.getToDetails = function () {
            $state.go('tab.HelperComputerDetails');
        };
        //钉钉标题与返回键设置
        dd.ready(function() {
