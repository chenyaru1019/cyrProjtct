(function() {
                ...
                biz: [{
                    ...
                    },
                    {
                        ...
                        paramsCallback: function(a) {
                            var n = a.value,
                                i = [];
                            if (n && "Object" == e.type(n)) if (e.ios) n = JSON.stringify(n);
                            else if (e.android) {
    ...
    function(e, a) {
        ...
        function n(a, n, i) {
            ...
            } else e.ios && (c ? (window.WebViewJavascriptBridge && WebViewJavascriptBridge.registerHandler(a,
                function(e, a) {
                    t({
                        errorCode: "0",
                        errorMessage: "成功",
        ...
        e.extend(e, {
            ...
            ready: function(n) {
                var i = this,
                    c = function(a) {
                        ...
                        if (null === s) m || (console.log("没有配置dd.config"), m = !0),
                            n(a);
                        else if (e.ios) a.callHandler(r, s,
                            function(e) {
                                var i = e || {},
                                    o = i.errorCode,
                                    s = i.errorMessage || "";
                        ...
                        if (o === !1 && (o = !0, e.events.forEach(function(n) {
                            ...
                            location.href.indexOf("dingtalk.com") > -1 && (e.internal.log.add({
                                text: "dd.ready"
                            }), e.ios && i.compareVersion(e.version, "3.5.0") && (console.log("dd.js runtime.monitor.usability"), e.runtime.monitor.usability()))
                        }
                    };
                ...
                if (e.android && a.WebViewJavascriptBridgeAndroid) return c(WebViewJavascriptBridgeAndroid);
                if (e.ios) document.addEventListener("WebViewJavascriptBridgeReady",
                    function() {
                    ...
                    a.nuva && (void 0 === a.nuva.isReady || a.nuva.isReady) ? p() : document.addEventListener("runtimeready",
                        function() {
                            p()
                        },
                        !1)
            ...
            compareVersion: function(e, a, n) {
                ...
                for (var i, o, s = e.split("."), r = a.split("."); i === o && r.length > 0;) i = s.shift(),
                    o = r.shift();
                return n ? (0 | o) >= (0 | i) : (0 | o) > (0 | i)
            }
        });
        var l = function(a, n) {
                for (var i = a.split("."), o = e, s = 0, r = i.length; r > s; s++) s === r - 1 && (o[i[s]] = n),
            ...
            p = function(a, o, s) {
                return c ? new Promise(function(r, d) {
                    o = o || {},
                        o._onSuccess = o.onSuccess ||
                            function() {},
                        o._onFail = o.onFail ||
                            function() {},
                        o._onCancel = o.onCancel ||
                            function() {},
                ...
                e.cfg && e.cfg.corpId && (o.corpId = e.cfg.corpId), n(a, o, s), void 0)
            };
        for (var u in e.methods) e.methods[u].forEach(function(e) {
            l(e.namespace,
                function(a) {
